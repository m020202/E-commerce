...
> 전자상거래에서는 **판매, 거래, 배송, 고객 정보** 등의 모든 과정에서 빅데이터가 생성되고 있기 때문에 빅데이터 분석을 잘 이용한다면 효과적인 전자상거래 운영 전략을 수집할 수 있다.
>
...
**OMOTs**란 전자상거래와 관련한 데이터를 수집 및 전처리하고 데이터를 가공한 후 판매를 수행하는 기업을 의미한다.
